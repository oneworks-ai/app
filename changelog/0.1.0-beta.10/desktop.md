...
- Give cold local-plugin source compilation enough time during packaged-server smoke tests so valid macOS release builds are not rejected by the generic five-second request deadline.
