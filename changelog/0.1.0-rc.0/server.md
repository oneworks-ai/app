...
- Keep worktree-scoped development service ownership in a machine registry so deleted worktrees can report and precisely stop orphaned processes without PID reuse risk.
...
- Create project data assets through a fail-closed macOS filesystem authority that rejects redirected destinations and never overwrites an existing file.
