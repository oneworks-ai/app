...
- Refine configuration collections with searchable preset and action cards, responsive drag reordering, multi-profile model-service setup, compact quota summaries, consistent platform icons, and stable hover actions that do not shift card content.
