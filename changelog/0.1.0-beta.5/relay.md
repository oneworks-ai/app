...
- Add team project-rule list and detail pages with Git repository matching, application settings, related-file visibility, automatic persistence, and stable breadcrumb/tab behavior.
