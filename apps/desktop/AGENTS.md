...
- `src/main/`
  ...
  - `first-action-diagnostics.ts`：真实首个 submit 到 accepted / renderer response / success、failed 或 terminated 的独立 operation；只消费无内容 milestone，并锁定首次 renderer document source
