...
export interface ChannelContext {
  ...
  /** Resolve the bound session's adapter account detail when supported */
  getBoundSessionAccountDetail?: (options?: { refresh?: boolean }) => Promise<AdapterAccountDetail | undefined>
