  ...
  apply({ exec, ensureColumn }) {
    exec(`
      CREATE TABLE IF NOT EXISTS sessions (
        ...
        messageBranchGroupId TEXT,
        messageBranchSourceSessionId TEXT,
        messageBranchSourceMessageId TEXT,
        messageBranchBaseMessageIndex INTEGER,
        messageBranchAction TEXT,
        title TEXT,
        lastMessage TEXT,
    ...
    ensureColumn('sessions', 'messageBranchGroupId', 'TEXT')
    ensureColumn('sessions', 'messageBranchSourceSessionId', 'TEXT')
    ensureColumn('sessions', 'messageBranchSourceMessageId', 'TEXT')
    ensureColumn('sessions', 'messageBranchBaseMessageIndex', 'INTEGER')
    ensureColumn('sessions', 'messageBranchAction', 'TEXT')
