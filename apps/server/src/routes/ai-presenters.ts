...
import { isAlwaysRule, resolveDefinitionName, resolveDocumentDescription } from '@oneworks/definition-core'
import type { Definition, Entity, Rule, Spec, WorkspaceDefinitionPayload } from '@oneworks/types'
...
export const presentEntity = (entity: Definition<Entity>, cwd: string) => {
  ...
  return {
    ...
    name,
    ...(entity.attributes.avatar != null && entity.attributes.avatar !== ''
