    ...
    mockExecResponses(
      ...
      { stdout: '# branch.head feature/current\n' },
      {
        stdout: [
          ...
          'main\trefs/heads/main\t/Users/yijie/codes/oneworks-app',
          'origin/main\trefs/remotes/origin/main\t'
        ].join('\n')
      }
    )
  ...
  it('lists git worktrees for the current repository', async () => {
    mockExecResponses(
      { stdout: '/workspace\n' },
      {
        stdout: [
          ...
          '',
          'worktree /Users/yijie/.codex/worktrees/3d03/oneworks-app',
    ...
    await expect(listSessionGitWorktrees('sess-1')).resolves.toEqual({
      worktrees: [
        ...
        {
          path: '/Users/yijie/.codex/worktrees/3d03/oneworks-app',
