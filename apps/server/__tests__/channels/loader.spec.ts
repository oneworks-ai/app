...
describe('loadChannelModule', () => {
  ...
  it('ignores missing optional mcp exports', async () => {
    ...
    requireMock.mockImplementation((specifier: string) => {
      if (specifier === '@oneworks/channel-lark') {
        return {
          channelDefinition: {
      ...
      if (specifier === '@oneworks/channel-lark/connection') {
        return { createChannelConnection }
      }

      if (specifier === '@oneworks/channel-lark/mcp') {
        const error = new Error(
          'Package subpath \'./mcp\' is not defined by "exports" in /tmp/node_modules/@oneworks/channel-lark/package.json'
  ...
  it('loads external scoped channel packages by declared channel type', async () => {
    ...
    try {
      ...
      requireMock.mockImplementation((specifier: string) => {
        if (specifier === '@oneworks/channel-external-channel') {
