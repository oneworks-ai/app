...
interface ImportMetaEnv {
  ...
  readonly __ONEWORKS_PROJECT_CLIENT_BUILD_TIME__: string
  readonly __ONEWORKS_PROJECT_CLIENT_BUILD_TIME_SOURCE__: string
...
interface Window {
  ...
  __ONEWORKS_PROJECT_CLIENT_BUILD_INFO_JSON__?: string
}
