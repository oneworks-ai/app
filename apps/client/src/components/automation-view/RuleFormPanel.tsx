...
export type AutomationCreateMode = 'form' | 'chat'

export interface RuleFormPanelHandle {
  submit: () => void
}

interface RuleFormPanelProps {
  createMode: AutomationCreateMode
  mode: 'create' | 'edit'
...
export const RuleFormPanel = forwardRef<RuleFormPanelHandle, RuleFormPanelProps>(({
  createMode,
  mode,
  rule,
  onSubmit
...
RuleFormPanel.displayName = 'RuleFormPanel'
