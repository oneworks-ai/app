...
export const createAssetSubmitHandlers = (
  form: Pick<FormInstance<CreateAssetFormValues>, 'submit'>,
  onSave: () => void
) => ({
  onFinish: onSave,
  onOk: () => form.submit()
...
export function CreateAssetModal({
  ...
  const submitHandlers = createAssetSubmitHandlers(form, onSave)
  ...
  return (
    ...
    >
      <Form
        ...
        onFinish={submitHandlers.onFinish}
      >
        <Form.Item
          name='name'
            ...
            {(fields, { add, remove }) => (
              <div className='knowledge-base-view__asset-params'>
                <div className='knowledge-base-view__asset-params-heading'>
                  ...
                  <Button
                    type='link'
                    aria-label={t('knowledge.assets.addParam')}
                    onClick={() => add()}
                  >
                ...
                {fields.map((field, index) => {
                  return (
                    <div className='knowledge-base-view__asset-param-row' key={field.key}>
                      <Form.Item
                        {...field}
