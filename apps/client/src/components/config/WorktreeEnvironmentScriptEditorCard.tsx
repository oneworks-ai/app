...
import type { WorktreeEnvironmentScriptKey } from '@oneworks/types'
...
const scriptEnvVars = [
  'ONEWORKS_WORKTREE_ENV',
  'ONEWORKS_WORKTREE_OPERATION',
  'ONEWORKS_WORKTREE_PATH',
  'ONEWORKS_SESSION_ID',
  'ONEWORKS_WORKTREE_SOURCE_PATH',
  'ONEWORKS_REPOSITORY_ROOT',
  'ONEWORKS_WORKTREE_BASE_REF',
  'ONEWORKS_WORKTREE_FORCE'
]
