...
export function MessageContextMenuContent({
  ...
  return (
    <div className='message-context-menu ant-dropdown-menu' onContextMenu={(event) => event.preventDefault()}>
      {entries.map((entry) => {
        if (entry.type === 'divider') {
          return <div key={entry.key} className='message-context-menu__divider ant-dropdown-menu-item-divider' />
        }
        ...
        return (
          <div
            ...
            role='button'
            tabIndex={0}
            className={`message-context-menu__item ant-dropdown-menu-item message-context-menu__item--${entry.key} ${
