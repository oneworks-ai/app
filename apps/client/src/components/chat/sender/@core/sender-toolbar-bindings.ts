...
export const createSenderToolbarBindings = ({
  ...
  selection: {
    adapterOptions?: SenderToolbarData['adapterOptions']
    ...
    hiddenBuiltinAdapterOptions?: SenderToolbarData['hiddenBuiltinAdapterOptions']
  ...
  const toolbarState: SenderToolbarState = {
    ...
    hideSelectionControls: ui.hideSelectionControls,
  ...
  const toolbarData: SenderToolbarData = {
    ...
    builtinPreviewModelOptions: selection.builtinPreviewModelOptions,
    ...
    hiddenBuiltinAdapterOptions: selection.hiddenBuiltinAdapterOptions,
