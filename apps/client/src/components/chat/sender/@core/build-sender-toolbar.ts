...
export const buildSenderToolbar = ({
  ...
  return createSenderToolbarBindings({
    ...
    selection: {
      ...
      hiddenBuiltinAdapterOptions: props.hiddenBuiltinAdapterOptions,
      accountOptions: props.accountOptions,
      effort: props.effort ?? 'default',
      effortOptions: props.effortOptions ?? [],
      builtinPreviewModelOptions: props.builtinPreviewModelOptions,
    ...
    ui: {
      ...
      hideSelectionControls: props.hideSelectionControls === true,
      ...
      stopLoading: props.stopLoading === true,
      supportsEffort
    }
  })
}
