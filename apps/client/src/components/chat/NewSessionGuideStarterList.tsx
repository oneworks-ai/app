...
const FAVORITE_STARTER_STORAGE_KEY = 'oneworks_new_session_guide_favorites'
const RECENT_STARTER_STORAGE_KEY = 'oneworks_new_session_guide_recent'
const DEFAULT_VISIBLE_STARTER_COUNT = 3
        ...
        <div className='new-session-guide__sections-footer'>
          {shouldShowExpand && (
            <button type='button' className='new-session-guide__more-button' onClick={() => setShowAllRemaining(true)}>
              <span className='material-symbols-rounded new-session-guide__more-button-icon'>expand_more</span>
              <span className='new-session-guide__more-button-label'>
          ...
          {shouldShowCollapse && (
            ...
            >
              <span className='material-symbols-rounded new-session-guide__more-button-icon'>expand_less</span>
              <span className='new-session-guide__more-button-label'>{t('chat.newSessionGuide.showLess')}</span>
            </button>
          )}
        </div>
      )}
