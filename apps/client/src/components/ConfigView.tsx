...
const configQueryKeys: string[] = ['tab', 'source', 'detail', 'section', ...modelServiceImportQueryKeys]
const configQueryDefaults: Partial<ConfigQueryParams> = { tab: 'general', source: '', detail: '', section: '' }
