import type { ConfigResponse, GitBranchKind } from '@oneworks/types'
...
export const getChatSessionWorkspaceDraftFromConfig = (
  ...
  return buildChatSessionWorkspaceDraft(conversation?.createSessionWorktree ?? false, conversation?.worktreeEnvironment)
}
