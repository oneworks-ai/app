export const relayPermissions = {
  ...
  adminDiagnosticsRead: 'admin.diagnostics.read',
  adminModelUsageRead: 'admin.modelUsage.read',
  ...
  adminAccessGroupsRead: 'admin.accessGroups.read',
  adminAccessGroupsWrite: 'admin.accessGroups.write',
  relayMessagesRead: 'relay.messages.read',
  relayMessagesWrite: 'relay.messages.write',
  relayDiagnosticsWrite: 'relay.diagnostics.write',
  relayTeamAuditRead: 'relay.teamAudit.read',
  relayTeamConfigProfilesRead: 'relay.teamConfigProfiles.read',
  relayTeamConfigProfilesWrite: 'relay.teamConfigProfiles.write',
  relayTeamConfigSecretsRead: 'relay.teamConfigSecrets.read',
  relayTeamConfigSecretsWrite: 'relay.teamConfigSecrets.write',
  relayConfigSnapshotRead: 'relay.configSnapshot.read',
  relayTeamMembersRead: 'relay.teamMembers.read',
  relayTeamMembersWrite: 'relay.teamMembers.write',
  relayTeamModelUsageRead: 'relay.teamModelUsage.read',
  relayTeamsRead: 'relay.teams.read',
  relayTeamsWrite: 'relay.teams.write',
