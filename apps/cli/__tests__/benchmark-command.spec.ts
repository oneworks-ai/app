...
describe('benchmark command', () => {
  ...
  it('passes --yolo as bypassPermissions for benchmark runs', async () => {
    runBenchmarkCategoryMock.mockResolvedValue({
      results: [{
        category: 'quality',
        title: 'cli-yolo',
        status: 'pass',
    ...
    expect(runBenchmarkCategoryMock).toHaveBeenCalledWith(expect.objectContaining({
      category: 'quality',
      permissionMode: 'bypassPermissions'
    }))
    expect(runBenchmarkCaseMock).not.toHaveBeenCalled()
  })
})
