...
.oneworks-channel__entity-card { align-items: center; background: var(--content-background-color, var(--bg-color)); border: 1px solid var(--border-color, #d8dee4); border-radius: 6px; color: inherit; cursor: pointer; display: grid; font: inherit; gap: 10px; grid-template-columns: 36px minmax(0, 1fr) 18px; min-height: 66px; padding: 10px; text-align: left; }
