...
The public Chrome extension and Chrome Web Store product name is `OneWorks`. Keep the Settings capability page named `External Browser` / `外部浏览器`, and preserve stable package, Store ID, protocol, storage, global, and DOM identifiers.
