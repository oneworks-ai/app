...
oneWorks External Browser is intended for developers who want an Agent to work with their real browser while preserving visible control, recoverable permissions, target isolation, and an explicit audit trail.
