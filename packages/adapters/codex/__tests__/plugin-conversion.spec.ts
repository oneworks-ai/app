      ...
      JSON.stringify({
        apps: {
          good: {
            authentication: {
              authorizationUrl:
                'https://example.test/oauth?client_id=docs&redirect_uri=%2Foauth%2Fcallback&redirect_url=https%3A%2F%2Fapp.example.test%2Fauth%2Fcallback&code_challenge=valid&login_hint=docs',
              type: 'oauth2'
            },
            id: 'connector_good',
            permissions: ['repository:read']
          },
          filesystemUrlQueryKey: {
            authentication: {
              authorizationUrl: `https://example.test/oauth?${encodeURIComponent(pluginRoot)}=value`,
              type: 'oauth2'
            },
            id: 'connector_filesystem_query_key'
          },
          filesystemUrlQueryValue: {
            authentication: {
              tokenUrl: `https://example.test/token?next=${encodeURIComponent(pluginRoot)}`,
              type: 'oauth2'
            },
            id: 'connector_filesystem_query_value'
          },
          filesystemUrlFragment: {
            connectionRequirements: {
              endpoint: `https://example.test/connect#${encodeURIComponent(pluginRoot)}`,
              type: 'oauth'
            },
            id: 'connector_filesystem_fragment'
          },
          filesystemRedirectRoute: {
            authentication: {
              authorizationUrl: 'https://example.test/oauth?redirect_uri=%2FUsers%2Funrelated%2Foauth%2Fcallback',
              type: 'oauth2'
            },
            id: 'connector_filesystem_redirect_route'
          },
          filesystemCallback: {
            authentication: {
              callbackPath: `/oauth/callback?next=${encodeURIComponent(pluginRoot)}`,
              type: 'oauth2'
            },
            id: 'connector_filesystem_callback'
          },
          controlAuthorizationUrl: {
            authentication: {
              authorizationUrl: 'ht\ntps://example.test/oauth',
              type: 'oauth2'
            },
            id: 'connector_control_authorization'
          },
          controlTokenUrl: {
            authentication: {
          ...
          controlEndpoint: {
            ...
            id: 'connector_control_endpoint'
          },
          deeplyEncodedControlAuthorizationUrl: {
            authentication: {
              authorizationUrl: 'https://example.test/oauth%252525250Aauthorize',
              type: 'oauth2'
            },
            id: 'connector_deep_control_authorization'
          },
          deeplyEncodedControlTokenUrl: {
            authentication: {
              tokenUrl: 'https://example.test/to%252525250Aken',
              type: 'oauth2'
            },
            id: 'connector_deep_control_token'
          },
          deeplyEncodedControlCallbackPath: {
            authentication: {
              callbackPath: '/oauth/call%252525250Aback',
              type: 'oauth2'
            },
            id: 'connector_deep_control_callback'
          },
          deeplyEncodedControlEndpoint: {
            connectionRequirements: {
              endpoint: 'https://example.test/con%252525250Anect',
              type: 'oauth'
            },
            id: 'connector_deep_control_endpoint'
          },
