...
import { defineAdapterConfigContribution, effortLevelSchema, jsonValueSchema } from '@oneworks/core/config-schema'
...
const kimiCliConfigSchema = z.object({
  ...
  prepareOnInstall: z.boolean().optional().describe('Preinstall Kimi CLI during One Works package install'),
