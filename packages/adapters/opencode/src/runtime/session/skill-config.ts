...
import type { AdapterCtx, AdapterQueryOptions, Definition, Skill } from '@oneworks/types'
import { resolveProjectOoPath, syncSymlinkTarget } from '@oneworks/utils'
...
export const ensureOpenCodeConfigDir = async (params: {
  ...
  const configDir = resolve(
    resolveProjectOoPath(params.ctx.cwd, params.ctx.env, '.mock', '.opencode-adapter'),
