...
const adapterPackageDir = dirname(require.resolve('@oneworks/adapter-opencode/package.json'))
...
export const resolveOpenCodeBinaryPath = (
  ...
  const envPath = env.__ONEWORKS_PROJECT_ADAPTER_OPENCODE_CLI_PATH__
