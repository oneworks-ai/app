...
export interface ServerEnv {
  ...
  __ONEWORKS_PROJECT_RUNTIME_BROKER_URL__?: string
  __ONEWORKS_PROJECT_RUNTIME_BROKER_TOKEN__?: string
  __ONEWORKS_PROJECT_CODEX_SHARED_MODEL_TOKEN__?: string
...
export function loadEnv(): ServerEnv {
  ...
  const {
    ...
    __ONEWORKS_PROJECT_RUNTIME_BROKER_URL__,
    __ONEWORKS_PROJECT_RUNTIME_BROKER_TOKEN__,
    __ONEWORKS_PROJECT_CODEX_SHARED_MODEL_TOKEN__,
