...
export function normalizeCursorColor(value) {
...
export function resolveCursorBorderColor(fillColor) {
...
export function createOneWorksCursorSvg({ borderColor, color, size = 256 }) {
