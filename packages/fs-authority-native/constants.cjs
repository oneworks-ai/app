...
const resolveDefaultControlRoot = home => resolve(home, '.oneworks', 'runtime', `fs-authority-v${PROTOCOL_VERSION}`)
const prepareControlRoot = override => {
  ...
  return preparePrivateDirectory(home, resolveDefaultControlRoot(home))
}
