...
/**
 * Converts a user-facing data-asset name to its shared filesystem and semantic
 * identifier. It intentionally returns `undefined` for unsafe names so callers
 * can surface a validation error before making a path from user input.
 */
