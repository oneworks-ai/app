import { CANONICAL_ONEWORKS_MCP_SERVER_NAME, isCanonicalOneworksMcpServerName } from './oneworks-mcp'
...
export const normalizePermissionToolName = (
  ...
  if (serverName != null && serverName !== '') {
    if (isCanonicalOneworksMcpServerName(serverName)) {
      return {
        key: CANONICAL_ONEWORKS_MCP_SERVER_NAME,
        label: CANONICAL_ONEWORKS_MCP_SERVER_NAME,
        scope: 'tool'
      }
    }
  ...
  if (trimmed.startsWith('mcp__')) {
    ...
    if (isCanonicalOneworksMcpServerName(serverPart)) {
      return {
        key: CANONICAL_ONEWORKS_MCP_SERVER_NAME,
        label: CANONICAL_ONEWORKS_MCP_SERVER_NAME,
        scope: 'tool'
