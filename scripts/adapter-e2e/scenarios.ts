  ...
  codex: [
    {
      ...
      candidates: [
        {
          path: path.resolve(mockHome, '.codex/hooks.json'),
  ...
  'claude-code': [
    {
      ...
      candidates: [
        {
          path: path.resolve(mockHome, '.claude/settings.json'),
          includes: ['"hooks"']
        }
      ]
    }
  ...
  opencode: [
    {
      ...
      candidates: [
        {
          path: path.resolve(mockHome, '.config/opencode/opencode.json'),
          includes: ['https://opencode.oo/config.json']
        }
      ]
    },
    {
      ...
      candidates: [
        {
          path: path.resolve(mockHome, '.config/opencode/plugins/oneworks-hooks.js'),
          includes: ['OneWorksHooks', 'call-hook.js', 'tool.execute.before', 'tool.execute.after']
        }
      ]
    },
    {
      ...
      candidates: [
        {
          path: path.resolve(mockHome, '.opencode-adapter', ':sessionId', 'config-dir', 'opencode.json'),
