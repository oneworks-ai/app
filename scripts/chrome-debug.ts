...
(() => {
  ...
  document
    .querySelectorAll('[data-oneworks-chrome-debug-target="message-bubble"]')
    .forEach((element) => element.removeAttribute('data-oneworks-chrome-debug-target'));
  ...
  best.element.setAttribute('data-oneworks-chrome-debug-target', 'message-bubble');
...
(() => {
  const bubble = document.querySelector('[data-oneworks-chrome-debug-target="message-bubble"]');
