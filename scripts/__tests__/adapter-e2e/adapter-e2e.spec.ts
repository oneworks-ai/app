...
describeE2E('adapter e2e harness', () => {
  ...
  beforeAll(async () => {
    harness = await createAdapterE2EHarness({
      cases: selectedCases,
      passthroughStdIO: process.env.ONEWORKS_E2E_VERBOSE === '1',
      printSummary: false
    })
  }, 300_000)
