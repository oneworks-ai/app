...
import { projectHome } from '../../adapter-e2e/runtime'
...
const createResult = (): AdapterE2EResult => ({
  ...
  logPath: path.resolve(projectHome, 'logs/hooks-smoke-codex-1/00000000-0000-0000-0000-000000000000.log.md'),
...
describe('adapter e2e hook log parsing', () => {
  it('parses tool hook entries with header text and invalid json payloads', () => {
    ...
    expect(entries[2]?.textBlock).toContain('stdout: # OneWorks AI')
