...
updated: 2026-04-19
targetVersion: vNext
trackingIssue: https://github.com/oneworks-ai/app/issues/137
futureIssue: https://github.com/oneworks-ai/app/issues/138
---
...
Add `extends` and `inherit` fields to One Works entities so a project entity can build on existing local or plugin entities.
...
- Do not introduce package-name entity references such as `@oneworks/plugin-standard-dev/dev-reviewer`.
