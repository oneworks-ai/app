...
- 扫描 `.oo/benchmark/<category>/<title>/`
- 解析 `rfc.md`
- 准备 `.oo/worktrees/benchmark/<category>/`
- 建立 category 级共享 workspace 与 case 级隔离层
- 支持单 case 执行与 category 批量执行
- 生成 `.oo/results/<category>/<title>/result.json`
...
- `ow benchmark list`
- `ow benchmark run --category <category>`
- `ow benchmark run --category <category> --title <title>`
- `ow benchmark show`
