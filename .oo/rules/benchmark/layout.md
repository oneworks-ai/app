...
```text
.oo/worktrees/benchmark/<category>/
.oo/results/<category>/<title>/result.json
```

- `.oo/worktrees/benchmark/<category>/` 是 category 级共享 workspace。
- `.oo/results/<category>/<title>/result.json` 是 case 级唯一结果文件。
