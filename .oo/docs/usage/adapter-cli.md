...
- npm 托管：`codex`、`gemini`、`grok`、`copilot`、`opencode`、`pi`、`claude-code.cli`、`claude-code.routerCli`
- uv 托管：`kimi.cli`
...
同样可以用环境变量临时覆盖，`<ADAPTER>` 使用大写下划线，例如 `CODEX`、`GEMINI`、`GROK`、`CLAUDE_CODE`、`CLAUDE_CODE_ROUTER`：
