...
```bash
oneworks adapter prepare codex claude-code gemini grok pi
...
Temporary environment overrides use upper-case adapter names such as `CODEX`, `GEMINI`, `GROK`, `CLAUDE_CODE`, and `CLAUDE_CODE_ROUTER`:
