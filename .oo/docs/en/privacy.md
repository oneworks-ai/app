# oneWorks External Browser Extension Privacy Policy

Effective date: July 14, 2026

This policy explains how the “oneWorks External Browser” Chrome extension handles user data. The extension has one purpose: after an explicit pairing, it lets a user-authorized oneWorks Agent operate and debug browser targets selected by the user.
